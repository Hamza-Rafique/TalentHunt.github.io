        ...
        <div class="col-12">
            <div class="card card-inverse" style="background-image: url(pics/lapi.jpg);width: auto;height: 500px; border-color: #333;">
                ...
                <div class="mt-5">
                        ...
                        <a  href="../admin_users.php?show"><button class="btn btn-lg btn-outline-success ml-lg-5" >See All Users</button></a>
                        <a href="agent_admin.php"><button class="btn btn-lg btn-outline-success ml-lg-5" name="best_performers">See Agents</button></a>
                        <a href="cart.php"<button class="btn btn-lg btn-outline-success ml-lg-5" name="carts">Check Carts</button></a>
