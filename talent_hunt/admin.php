    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarid">
            <ul class="navbar-nav text-center ml-auto">
                ...
                <li class="nav-item">
                    <a href="adcompetition.php" class="nav-link">Competitions</a>
                </li>
            ...
            <div class="card card-inverse" style="background-image: url(pics/lapi.jpg);width: auto;height: 500px; border-color: #333;">
                ...
                <div class="mt-5">
                    <form action="admin_users.php" method="post">
                        <button class="btn btn-lg btn-outline-success ml-lg-5" name="all_users">See All Users</button>
                        <button class="btn btn-lg btn-outline-success ml-lg-5" name="best_performers">See Best Performers</button>
                        <button class="btn btn-lg btn-outline-success ml-lg-5" name="carts">Check Carts</button>
                    </form>
                </div>
            </div>
